...
class MySpider:
    ...
    def startUp(self,url,key):
        ...
        try:
            ...
            try:
                ...
                sql = "create table testmodel_phones (mNo varchar(32) primary key,mMark varchar(256),mPrice varchar(32),mNote varchar(1024),mFile varchar(256))"
    ...
    def showDB(self):
        try:
            ...
            cursor.execute("select mNo,mMark,mPrice,mFile,mNote from testmodel_phones order by mNo")
